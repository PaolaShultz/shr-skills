...
| skills.sh | <https://skills.sh/docs>, <https://skills.sh/docs/faq> |
...
| --- | --- | --- | --- |
| Canonical repository | Prepared | <https://github.com/PaolaShultz/shr-skills> | Distribution files prepared locally; publication state is updated after push. |
| Public landing page | Prepared | <https://paolashultz.github.io/shr-skills/> | Pages source prepared; public resolution is updated after deployment. |
| OpenAI Plugins Directory | Prepared | <https://platform.openai.com/plugins> | Skills-only plugins are documented; final portal state is updated after the submission attempt. |
| Anthropic plugin directory | Prepared | <https://platform.claude.com/plugins/submit> | Public-repository submission is documented; final form state is updated after the submission attempt. |
| GitHub agent skill | Prepared | <https://github.com/PaolaShultz/shr-skills> | Publication requires GitHub CLI 2.90.0 or later and a successful dry run. |
| skills.sh | Prepared | <https://skills.sh/PaolaShultz/shr-skills> | No manual submission exists; truthful listing depends on real install telemetry. |
| Cursor | Prepared | <https://github.com/PaolaShultz/shr-skills> | Current docs support GitHub import; no general public marketplace submission is documented. |
| OpenAI Developer Showcase | Prepared | <https://developers.openai.com/showcase> | Official pages establish the Showcase; a public submission mechanism must be confirmed before use. |
| OpenAI Developer Forum | Prepared | <https://community.openai.com/> | Current forum rules, category, authentication, and duplicates must be confirmed before posting. |
| Show HN | Prepared | <https://news.ycombinator.com/showhn.html> | Posting depends on direct runnability, authenticated account, rule compliance, and no equivalent submission. |
